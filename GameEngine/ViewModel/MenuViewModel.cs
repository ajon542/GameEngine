...
namespace GameEngine.ViewModel
{
    public class MenuViewModel
    {
        ...
        public MenuViewModel(IEnumerable<DockWindowViewModel> dockWindows)
        {
            ...
            // 3D Object -> BezierPatch.
            viewModel.Items.Add(new CreateGameObjectMenuItemViewModel("BezierPatch") { Header = "BezierPatch" });
            ...
            {
                MenuItemViewModel about = new AboutMenuItemViewModel { Header = itemName };
